...
class Cart(models.Model):
    ...
    #このフィールドはいるのだろうか？注文があった時、カートの中身は消すべきでは？残していてもDBを圧迫するだけで
    ...
    #TODO:カートの商品の数量変更を行う時、 [商品の在庫 >= 変更後の数量] の条件に一致しているかをチェックする
...
class OrderDetail(models.Model):
    ...
    #TODO:この部分はProductを継承して作るべきではないか？(Productのフィールドによってここに記録する内容も変わるから)
